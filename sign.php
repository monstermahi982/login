...
<form method="POST" action="connection.php" style="border:1px solid #ccc">
  <div class="container">
    <h1>Sign Up</h1>
    <p>Please fill the information to enter in MONSTER world.</p>
    <hr>

    <label for="email"><b>First Name</b></label>
    <input type="text" placeholder="Enter your first name" name="fname" required>

    <label for="email"><b>Sur Name</b></label>
    <input type="text" placeholder="Enter your sur name" name="sname" required>
